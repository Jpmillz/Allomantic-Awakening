...
import io.github.jpmillz.allomanticawakening.capabilities.MetalData;
...
public class Registration {
    ...
    public static final Supplier<AttachmentType<MetalData>> METAL_DATA = ALLOMANTIC_ATTACHMENTS.register("metal_data", ()->AttachmentType.serializable(MetalData::new).build());
